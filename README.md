# <img src="src/assets/images/appicon.png" alt="CipherAuth" width="32" style="vertical-align: middle;" /> CipherAuth 
...
>
> Privacy Policy: See the full policy in [GIST File](https://github.com/ppriyanshu26/CipherAuth-Flutter/blob/main/GIST.md) or in [GitHub Gist](https://gist.github.com/ppriyanshu26/b9c863813ee032a9ffd9f94ff1f78aee).
...
- You can also download the latest versions from the [Releases Page](https://github.com/ppriyanshu26/CipherAuth-Flutter/releases) of the [GitHub repository](https://github.com/ppriyanshu26/CipherAuth-Flutter/).
